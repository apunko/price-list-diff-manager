...
const CatalogService = {
  updateCatalog: ({ filesDiff, chargeRates, newFile, oldFile, catalogFile }) => {
    ...
    const rowsObjects = ArrayDiffHelper.getNewPriceObjects(filesDiff, chargeRates, newFile, oldFile);
